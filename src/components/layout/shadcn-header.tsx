...
export function ShadcnHeader() {
  ...
  return (
    <>
      ...
      {/* 主导航栏 */}
      <header className="sticky top-0 z-50 w-full bg-background/95 shadow-[0_4px_10px_rgba(15,23,42,0.08)] backdrop-blur supports-[backdrop-filter]:bg-background/60">
