...
-- CreateEnum
CREATE TYPE "PaymentMethod" AS ENUM ('CREDIT_CARD', 'PAYPAL', 'BANK_TRANSFER', 'APPLE_PAY', 'GOOGLE_PAY');
...
-- CreateEnum
CREATE TYPE "AnnouncementActionType" AS ENUM ('NONE', 'URL', 'OPEN_LOGIN_MODAL', 'OPEN_REGISTER_MODAL');
...
CREATE TABLE "announcements" (
    ...
    "isActive" BOOLEAN NOT NULL DEFAULT true,
    "sortOrder" INTEGER NOT NULL DEFAULT 0,
    "actionType" "AnnouncementActionType" NOT NULL DEFAULT 'NONE',
    "linkUrl" TEXT,
...
CREATE TABLE "announcement_config" (
    ...
    "rotationInterval" INTEGER NOT NULL DEFAULT 5000,
    "createdAt" TIMESTAMP(3) NOT NULL DEFAULT CURRENT_TIMESTAMP,
    "updatedAt" TIMESTAMP(3) NOT NULL,

    CONSTRAINT "announcement_config_pkey" PRIMARY KEY ("id")
);
